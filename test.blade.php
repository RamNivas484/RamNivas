...
<div id="slider">
     <div class="left_hold" align="left"><img onClick="photo(-1)" class="left" src="images/arrow_left.jpg"></div>
	 <center>
     <img src="images/img1.jpg" id="image" >
     </center>
     <div class="right_hold" align="right"><img onClick="photo(1)" class="right" src="images/arrow_right.jpg"></div>
</div>
