...
input[type="password"], input[type="text"] ,input[type="date"] , input[type="number"] , select[name="dropdown1"]{
    ...
    <div class="panel panel-primary">
     ...
     <div class="panel-body">
	  <div class="login">
       ...
       <input type="submit" onclick="alert('Successfully Logged In!')" value="Register">
      </div>
	 </div>
    </div>
</html>